  ...
  <div>
    ...
    <el-container>
        ...
        <el-timeline>
            ...
            <el-card class="box-card">
              ...
              <el-form label-width="60px">
                <el-form-item label="行数" size="small">
                  <el-input v-model="rows" placeholder="请输入行数" />
                </el-form-item>
                <el-form-item label="列数" size="small">
                  <el-input v-model="cols" placeholder="请输入列数" />
                </el-form-item>
                <el-button
                  type="primary"
                  plain
          ...
          <el-timeline-item>
            <el-card class="box-card">
              ...
              <el-button type="primary" plain size="small" style="width: 100%" @click="step3_1()">
                普通座位
              </el-button>
              <br /><br />
              <el-button type="primary" plain size="small" style="width: 100%" @click="step3_2()">
                过道
              </el-button>
            </el-card>
          </el-timeline-item>
          ...
          <el-timeline-item>
            <el-card class="box-card">
              ...
              <el-button type="success" size="small" style="width: 100%" @click="step4()">
                选好了
              </el-button>
            </el-card>
          </el-timeline-item>
      ...
      <el-main>
        <!-- 提示内容 -->
        <div class="tip">
          <div class="tip-item" style="background:#36d6;"></div> 未选择座位&nbsp;&nbsp;
          <div class="tip-item" style="background:#36d;"></div> 已选择座位&nbsp;&nbsp;
          <div class="tip-item" style="background:#a11;"></div> 普通座位&nbsp;&nbsp;
          <div class="tip-item" style="background:#3333;"></div> 过道
        </div>
        <el-divider></el-divider>
...
export default {
  ...
  methods: {
    // 生成座位模板，并且绘制在canvas中
    step1() {
      //创建SeatSelector对象，传入行数列数，canvas
    ...
    step4(){
      if (this.seatSelector) {
        try {
          ...
          let id=this.id
          // 发送请求,更新放映厅的座位模板
          this.$http.CinemaRoomApi.updateSeatTemplate({id,seat_template,room_size}).then(res=>{
